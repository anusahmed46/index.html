 ...
 */
public class Mobilecloudcomputing implements Runnable{
    ...
    public Mobilecloudcomputing(String operation) {
        this.operation = operation;

    }
    
    public Mobilecloudcomputing(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException{
        initialize();
        Runnable receiver = new Mobilecloudcomputing("receiver");
        new Thread(receiver).start();
        
        // Thread.sleep(10);
        
              
        Runnable heartbeat = new Mobilecloudcomputing("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new Mobilecloudcomputing("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new Mobilecloudcomputing("sender","elecreq");
                    new Thread(sender).start(); 
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new Mobilecloudcomputing("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new Mobilecloudcomputing("timer");
